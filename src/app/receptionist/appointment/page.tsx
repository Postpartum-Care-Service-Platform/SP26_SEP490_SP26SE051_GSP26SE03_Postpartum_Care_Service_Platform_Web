...
// Import from Admin Appointment components
import { AppointmentHeader } from '@/app/admin/appointment/components/AppointmentHeader';
import { AppointmentTable } from '@/app/admin/appointment/components/AppointmentTable';
import { AppointmentTableControls } from '@/app/admin/appointment/components/AppointmentTableControls';
import { EditAppointmentModal } from '@/app/admin/appointment/components/EditAppointmentModal';
import { NewAppointmentModal } from '@/app/admin/appointment/components/NewAppointmentModal';
import type { Appointment, AppointmentStatus } from '@/app/admin/appointment/components/types';

import styles from '@/app/admin/appointment/appointment.module.css';
