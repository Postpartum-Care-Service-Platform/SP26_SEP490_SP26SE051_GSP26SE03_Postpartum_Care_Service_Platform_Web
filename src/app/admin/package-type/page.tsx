    ...
    <div className={styles.controls}>
      <div className={styles.controlsLeft}>
        <div className={styles.searchWrapper}>
          ...
          <input
            type="text"
            placeholder="Tìm kiếm loại gói dịch vụ..."
    ...
    >
      <div className={styles.tableWrapper}>
        <table className={styles.table}>
          ...
          <tbody>
            {loading ? (
              <tr><td colSpan={4} className={styles.placeholder}>Đang tải dữ liệu...</td></tr>
            ) : error ? (
                        ...
                        {item.isActive ? (
                          ...
                          <div className={styles.tooltipWrapper}>
                            <Button variant="outline" size="sm" className={styles.restoreButton}
                              onClick={() => handleRestore(item)} disabled={deletingId === item.id}>
                              <RestoreIcon />
                            </Button>
      ...
      <ConfirmModal
        ...
        title="Xác nhận xóa loại gói dịch vụ"
        message={`Bạn có chắc chắn muốn xóa loại gói dịch vụ "${itemToDelete?.typeName}"? Hành động này không thể hoàn tác.`}
        confirmLabel="Xóa ngay"
        cancelLabel="Suy nghĩ lại"
        variant="danger"
      />

      <ImportPackageTypeModal
