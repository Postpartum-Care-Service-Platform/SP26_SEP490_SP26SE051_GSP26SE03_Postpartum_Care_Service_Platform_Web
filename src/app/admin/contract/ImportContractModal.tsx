...
import styles from './import-contract-modal.module.css';
...
export const ImportContractModal: React.FC<ImportContractModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsUploading(true);
      await contractService.importContracts(file);
    ...
    <div className={styles.modalOverlay} onClick={() => !isUploading && onOpenChange(false)}>
      ...
      >
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>Nhập danh sách hợp đồng từ Excel</h2>
