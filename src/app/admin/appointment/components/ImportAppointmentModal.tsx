...
import styles from './import-appointment-modal.module.css';
...
export const ImportAppointmentModal: React.FC<ImportAppointmentModalProps> = ({
  open,
  onOpenChange,
  onSuccess,
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsUploading(true);
      await appointmentService.importAppointments(file);
    ...
    <div className={styles.modalOverlay} onClick={() => !isUploading && onOpenChange(false)}>
      ...
      >
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>Nhập lịch hẹn từ Excel</h2>
