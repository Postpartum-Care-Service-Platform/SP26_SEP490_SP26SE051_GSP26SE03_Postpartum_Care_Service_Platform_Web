...
import styles from './menu-type-table-controls.module.css';
...
export function MenuTypeTableControls({ onSearch, onSortChange, onStatusChange, onNewMenuType }: Props) {
  ...
  return (
    <div className={styles.controls}>
      ...
      <div className={styles.right}>
        ...
        <Button variant="primary" size="sm" className={styles.newMenuTypeButton} onClick={onNewMenuType}>
