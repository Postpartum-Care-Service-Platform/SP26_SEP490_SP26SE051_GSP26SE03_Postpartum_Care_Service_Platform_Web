...
import type { CreateAppointmentTypeRequest } from '@/types/appointment-type';
    ...
    try {
      ...
      const message =
        typeof error === 'object' && error && 'message' in error
          ...
          : '';
      toast({ title: message || 'Tạo loại lịch hẹn thất bại. Vui lòng thử lại.', variant: 'error' });
    } finally {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <span>Tạo loại lịch hẹn nhanh</span>
        </button>
      </div>
    );
  }
      ...
      <div className={styles.createTaskInner}>
        ...
        <div className={styles.createActions}>
          <div className={styles.submitBtnGroup}>
            ...
            >
              <span>{isSubmitting ? 'Đang tạo...' : 'Tạo loại lịch hẹn'}</span>
              {!isSubmitting && (
