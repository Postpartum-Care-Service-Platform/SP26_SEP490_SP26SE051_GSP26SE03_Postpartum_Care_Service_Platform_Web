...
import styles from './import-activity-modal.module.css';
...
export const ImportActivityModal: React.FC<ImportActivityModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsUploading(true);
      await activityService.importActivities(file);
    ...
    <div className={styles.modalOverlay} onClick={() => !isUploading && onOpenChange(false)}>
      ...
      >
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>Nhập hoạt động từ Excel</h2>
