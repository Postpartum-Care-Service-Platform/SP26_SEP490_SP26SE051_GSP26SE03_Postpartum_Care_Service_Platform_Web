...
import styles from './activity-table-controls.module.css';
...
const SORT_OPTIONS = [
  ...
  { value: 'name-asc', label: 'Tên hoạt động A-Z' },
  { value: 'name-desc', label: 'Tên hoạt động Z-A' },
];
  ...
  return (
    <div className={styles.controls}>
      ...
      <div className={styles.right}>
        ...
        <Button variant="primary" size="sm" className={styles.newActivityButton} onClick={onNewActivity}>
