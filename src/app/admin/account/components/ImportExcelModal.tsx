...
export function ImportExcelModal({ open, onOpenChange, onSuccess }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsUploading(true);
      await userService.importAccounts(file);
      ...
      // Tự động reload để cập nhật bảng tài khoản
      setTimeout(() => {
    ...
    <div className={styles.modalOverlay} onClick={() => !isUploading && onOpenChange(false)}>
      ...
      >
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>Nhập tài khoản từ Excel</h2>
