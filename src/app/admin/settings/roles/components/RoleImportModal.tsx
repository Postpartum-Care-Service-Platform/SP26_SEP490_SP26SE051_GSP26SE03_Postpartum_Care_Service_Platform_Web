...
import styles from './role-import-modal.module.css';
...
export function RoleImportModal({ open, onOpenChange, onSuccess }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsUploading(true);
      await roleService.importRoles(file);
      ...
      // Tự động reload để cập nhật bảng
      setTimeout(() => {
    ...
    <div className={styles.modalOverlay} onClick={() => !isUploading && onOpenChange(false)}>
      ...
      >
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>Nhập vai trò từ Excel</h2>
