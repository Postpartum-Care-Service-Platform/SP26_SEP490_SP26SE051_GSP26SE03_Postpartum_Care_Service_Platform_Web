...
export function ExportIcon({ className }: Props) {
  return (
...
export function ChevronDownSmallIcon({ className }: Props) {
  return (
...
export function LightningIcon({ className }: Props) {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function ViewListIcon({ className }: Props) {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
