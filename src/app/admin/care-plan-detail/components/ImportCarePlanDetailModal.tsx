...
import styles from './import-care-plan-detail-modal.module.css';

interface ImportCarePlanDetailModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSuccess?: () => void;
}

export const ImportCarePlanDetailModal: React.FC<ImportCarePlanDetailModalProps> = ({
  open,
  onOpenChange,
  onSuccess,
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsUploading(true);
      await carePlanDetailService.importCarePlanDetails(file);
    ...
    <div className={styles.modalOverlay} onClick={() => !isUploading && onOpenChange(false)}>
      ...
      >
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>Nhập hoạt động gói từ Excel</h2>
