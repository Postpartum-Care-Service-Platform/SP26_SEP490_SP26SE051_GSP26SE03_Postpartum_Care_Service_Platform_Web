...
export function ContractModalHeader({ title, onClose, onDownload, isDownloading }: ContractModalHeaderProps) {
  return (
    <div className={styles.header}>
      <div className={styles.leftSection}>
        <span className={styles.title}>{title}</span>
        <div 
          className={`${styles.downloadWrapper} ${isDownloading ? styles.disabled : ''}`} 
        ...
        >
          ...
          <span className={styles.downloadText}>{isDownloading ? 'Downloading...' : 'Download'}</span>
        </div>
      </div>
