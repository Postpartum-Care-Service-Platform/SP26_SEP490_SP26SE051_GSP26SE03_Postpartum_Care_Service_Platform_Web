...
import styles from './food-table-controls.module.css';
...
const SORT_OPTIONS = [
  ...
  { value: 'name-asc', label: 'Tên món A-Z' },
  { value: 'name-desc', label: 'Tên món Z-A' },
  ...
  return (
    <div className={styles.controls}>
      ...
      <div className={styles.right}>
        ...
        <Button variant="primary" size="sm" className={styles.newFoodButton} onClick={onNewFood}>
