...
import styles from './import-feedback-modal.module.css';
...
export const ImportFeedbackModal: React.FC<ImportFeedbackModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsUploading(true);
      await feedbackService.importFeedbacks(file);
    ...
    <div className={styles.modalOverlay} onClick={() => !isUploading && onOpenChange(false)}>
      ...
      >
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>Nhập danh sách phản hồi từ Excel</h2>
