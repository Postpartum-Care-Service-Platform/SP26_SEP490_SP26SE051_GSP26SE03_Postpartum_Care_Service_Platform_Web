...
import styles from './import-health-condition-modal.module.css';

interface ImportHealthConditionModalProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  onSuccess?: () => void;
}

export const ImportHealthConditionModal: React.FC<ImportHealthConditionModalProps> = ({
  open,
  onOpenChange,
  onSuccess,
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsUploading(true);
      await healthConditionService.import(file);
    ...
    <div className={styles.modalOverlay} onClick={() => !isUploading && onOpenChange(false)}>
      ...
      >
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>Nhập tình trạng sức khỏe từ Excel</h2>
          ...
          <div className={styles.templateSection}>
            ...
            <div className={styles.templateText}>
              ...
              <p className={styles.templateDesc}>
                ...
                Bạn có thể <span className={styles.downloadLink} onClick={handleDownloadTemplate}>tải file mẫu tại đây</span>.
              </p>
            </div>
          </div>
        </div>
