...
import styles from './import-placeholder-modal.module.css';
...
export const ImportPlaceholderModal: React.FC<ImportPlaceholderModalProps> = ({
  open,
  onOpenChange,
  onSuccess,
}) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsUploading(true);
      await placeholderService.importPlaceholders(file);
    ...
    <div className={styles.modalOverlay} onClick={() => !isUploading && onOpenChange(false)}>
      ...
      >
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>Nhập placeholder từ Excel</h2>
          ...
          <div className={styles.templateSection}>
            ...
            <div className={styles.templateText}>
              ...
              <p className={styles.templateDesc}>
                ...
                Bạn có thể chọn "Tải file mẫu" trong menu Nhập/Xuất.
              </p>
            </div>
          </div>
        </div>
