...
import styles from './menu-record-table-controls.module.css';

type Props = {
  onSearch?: (query: string) => void;
  onSortChange?: (sort: string) => void;
  onStatusChange?: (status: 'all' | 'active' | 'inactive') => void;
  onNewMenuRecord?: () => void;
};
...
export function MenuRecordTableControls({ onSearch, onSortChange, onStatusChange, onNewMenuRecord }: Props) {
    ...
    <div className={styles.controls}>
      <div className={styles.left}>
        <div className={styles.searchWrapper}>
          ...
          <input
            type="text"
            placeholder="Tìm kiếm bản ghi thực đơn..."
      ...
      <div className={styles.right}>
        ...
        <Button variant="primary" size="sm" className={styles.newMenuRecordButton} onClick={onNewMenuRecord}>
