...
import styles from './import-notification-modal.module.css';
...
export const ImportNotificationModal: React.FC<ImportNotificationModalProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsUploading(true);
      await notificationService.importNotifications(file);
    ...
    <div className={styles.modalOverlay} onClick={() => !isUploading && onOpenChange(false)}>
      ...
      >
        <div className={styles.modalHeader}>
          <h2 className={styles.modalTitle}>Nhập thông báo từ Excel</h2>
