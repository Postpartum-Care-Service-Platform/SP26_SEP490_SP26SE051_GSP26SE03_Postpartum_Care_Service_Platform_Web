...
import { managerNav, type ManagerNavItem } from '@/configs/managerNav';
...
export function ManagerSidebar({ collapsed, onToggleCollapsed }: Props) {
  ...
  const isItemActive = (item: ManagerNavItem) => {
    if (item.href) {
    ...
    <aside className={`${styles.sidebar} ${collapsed ? styles.sidebarCollapsed : ''}`}>
      <div className={styles.sidebarTop}>
        <div className={styles.brand}>
          ...
          {!collapsed && <span className={styles.brandText}>The Joyful Nest Manager</span>}
        </div>
