...
import { type ReceptionistNavSection, type ReceptionistNavItem } from '@/configs/receptionistNav';
...
type Props = {
  ...
  navSections: ReceptionistNavSection[];
  brandText: string;
};

export function ReceptionistSidebar({ collapsed, onToggleCollapsed, navSections, brandText }: Props) {
  ...
  const isItemActive = (item: ReceptionistNavItem) => {
    if (item.href) {
