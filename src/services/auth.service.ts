...
const authService = {
  ...
  createCustomer: (payload: { email: string; phone: string; username: string; memberTypeId: number }): Promise<{ message?: string }> =>
    apiClient.post('/Auth/create-customer', payload),
